    ...
    <div className="landing">
      ...
      <section className="features">
        ...
        <div className="features-grid" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
          {[
            { step: '01', title: 'Connect', desc: 'Provide your GitHub repository URL and access token' },
            ...
            <><motion.div
              ...
              >
                  ...
                  {item.step}
              </div><div style={{ marginTop: '2rem', marginBottom: '1rem' }}>
                  ...
                  </div><h3>{item.title}</h3><p>{item.desc}</p></>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <footer className="footer">
        <><div className="footer-links">
              ...
              <a href="#">Twitter</a>
              <a href="#">Discord</a>
          </div><p>© 2025 RiftAgent. Built with AI for developers.</p></>
      </footer>
    </div>
  )
}
